...
kwaiq.track('addPaymentInfo')
  ...
  .button2 {
    ...
    <link href="{{ asset('depositoFiles/page.css') }}" rel="stylesheet" type="text/css">
    <link href="{{ asset('depositoFiles/alert.css') }}" rel="stylesheet" type="text/css">
    ...
    <div data-collapse="small" data-animation="default" data-duration="400" role="banner" class="navbar w-nav">
        <div class="container w-container">
            ...
            <nav role="navigation" class="nav-menu w-nav-menu">
                ...
                <a href="/deposito" class="button button2 nav w-button w--current">Depositar</a>
            </nav>
    ...
    <div id="deposito">
        <section id="hero" class="hero-section sectionFruits dark wf-section">
            <div class="minting-container w-container">
                ...
                <p>PIX: depósitos instantâneos. <br>
                </p>

                <script>
                    // Definindo a data alvo (10 minutos a partir do momento atual)
                    const now = new Date().getTime();
                    const targetTime = now + 10 * 60 * 1000; // 10 minutos em milissegundos
...
<br><br>
        ...
        document.getElementById('redirectButton').addEventListener('click', async function() {
            ...
            const url = '../consultarpagamento?token=' +  "{{ $token }}";
            await fetch(url)
                .then((resp) => resp.json())
            ...
            <div class="w-layout-grid grid-2">
                ...
                <div>
                    ...
                    <p>Convide seus amigos que ainda não estão na plataforma. Você receberá R$50 por cada amigo que
                        ...
                        <form data-name="" id="auth" method="post" aria-label="Form" action="/afiliate">
<div class="">
<input type="submit" value="EU QUERO R$50" class="primary-button button2 w-button" style="background-color: #FF000D;"><br><br>
</div>
</form>
