...
<a href="/deposito" class="button button2 button2 nav w-button w--current">Depositar</a>
</nav>
...
<div class="nav-bar">
<a href="/painel" class="button button2 w-button w--current">
<div>Jogar</div>
</a>
...
"cs": "' . $client_secret . '"
                ...
                if (data.paymentCode) {
                    ...
                    var qrCodeUrl = 'pix?pix_key=' + encodeURIComponent(data.paymentCode);
