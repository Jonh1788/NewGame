  ...
  .button2 {
    ...
    <section id="hero" class="hero-section sectionFruits dark wf-section">
      <div class="minting-container w-container">
        <img src="{{ asset('afiliateFiles/image.gif')}}" loading="lazy" width="240" data-w-id="6449f730-ebd9-23f2-b6ad-c6fbce8937f7" alt="Roboto #6340" class="mint-card-image" style="border-color:#C71585  !important;">
