            ...
            <div class="col-md-6 col-lg-3 col-xlg-3">
              <div class="card card-hover">
                <div class="box bg-success text-center">
                  ...
                  <h4 class="text-white" id="valorUsuarios4"> {{ $quantidadeNumeroDepositos }}</h4>
            ...
            <div class="col-md-6 col-lg-3 col-xlg-3">
              <div class="card card-hover">
                <div class="box bg-danger text-center">
                  ...
                  <h4 class="text-white">{{$totalSaques}}</h4>
            ...
            <div class="col-md-6 col-lg-3 col-xlg-3">
              <div class="card card-hover">
                <div class="box bg-success text-center">
                  ...
                  <h4 class="text-white" id="valorUsuarios">{{ $quantidadeUsuarios }}</h4>
...
<div class="col-md-6 col-lg-3 col-xlg-3 mb-3">
    <div class="card card-hover">
        <div class="box bg-dark text-center">
            ...
            <form action="../adm/processos?opcao=depositoMin" method="POST" id="editForm3">
                @csrf
...
<script>
    function enviarAtualizacao(opcao, value){
        console.log(opcao)
        console.log(value)
        requisicao = `../adm/processos?opcao=${opcao}&value=${value}`;
...
function atualizarValor() {
    ...
    $.ajax({
        type: "POST",
        url: "../adm/atualizar_deposito_minimo",
...
<div class="col-md-6 col-lg-3 col-xlg-3 mb-3">
    <div class="card card-hover">
        <div class="box bg-dark text-center">
            ...
            <h7 class="text-white">R$:</h7>
            <form action="../adm/processos?opcao=saqueMin" method="post" id="editForm3">
                @csrf  
  ...
  <div class="col-md-6 col-lg-3 col-xlg-3 mb-3"> <!-- Adicionado mb-3 para margem inferior -->
    <div class="card card-hover">
      <div class="box bg-dark text-center">
        ...
        <h7 class="text-white">R$:</h7>
        <form action="../adm/processos?opcao=apostaMax" method="post" id="editForm3">
        @csrf    
  ...
  <div class="col-md-6 col-lg-3 col-xlg-3 mb-3">
    <div class="card card-hover">
        <div class="box bg-dark text-center">
            ...
            <form action="../adm/processos?opcao=dificuldadeJogo"  method="post" id="editForm3">  
  ...
  <div class="col-md-6 col-lg-3 col-xlg-3 mb-3"> <!-- Adicionado mb-3 para margem inferior -->
    <div class="card card-hover">
      <div class="box bg-dark text-center">
        ...
        <h7 class="text-white">R$:</h7>
        <form action="../adm/processos?opcao=apostaMin" method="post" id="editForm3">  
        @csrf  
  ...
  <div class="col-md-6 col-lg-3 col-xlg-3 mb-3"> <!-- Adicionado mb-3 para margem inferior -->
    <div class="card card-hover">
      <div class="box bg-dark text-center">
        ...
        <form action="../adm/processos?opcao=rolloverSaque" method="post" id="editForm3">  
        @csrf  
  ...
  <div class="col-md-6 col-lg-3 col-xlg-3 mb-3"> <!-- Adicionado mb-3 para margem inferior -->
    <div class="card card-hover">
      <div class="box bg-dark text-center">
        ...
        <h7 class="text-white">R%</h7>
        <form action="../adm/processos?opcao=taxaSaque" method="post" id="editForm3">  
        @csrf  
